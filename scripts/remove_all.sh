...
echo -e "🧹 \033[33m Cleaning saves \033[0m"
sudo rm -rf $SAVE_PATH

echo -e "🧹 \033[33m Cleaning logs \033[0m"
sudo rm -rf /var/log/fuse
echo -e "🧹 \033[33m Cleaning /etc/fuse/configurations \033[0m"
sudo rm -rf /etc/fuse/
echo -e "🧹 \033[33m Fuse fully uninstalled from your computer \033[0m"
